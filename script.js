...
const collections = [
  {
    ...
    description:
      "Secret cat paths, Tiny Paws rescues, and impossible Istanbul games from the Grand Bazaar to a giant miniature city, a moonlit toy gallery, and Rumeli Fortress.",
    cover: "assets/book-cover-cats-of-istanbul.webp",
    coverAlt:

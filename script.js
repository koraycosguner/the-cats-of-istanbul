const books = [
  ...
  {
    title: "Hakan, Yusuf, and the Flying Carpet Kittens",
    libraryKicker: "Tiny Paws, Big Istanbul — Book 1",
    readerKicker: "A Grand Bazaar rescue with one rope left",
    readerLayout: "compact-text",
    description:
      "A wind-filled carpet, two tiny hidden kittens, and one last safe swing for the brothers to time.",
    cover: "assets/book-cover-cats-flying-carpet-kittens.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Flying Carpet Kittens showing the brothers safely rescuing Lokum and Mercimek from a wind-filled Grand Bazaar carpet",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "Pepper-Sneeze",
        paragraphs: [
          "Hakan heard a sneeze inside the Grand Bazaar.",
          '“Pff-CHOO!”',
          "A tiny orange-and-white kitten burst from a pepper basket. He pounced on the tassel of a giant carpet just as four ropes lifted it for display.",
          "Then a roof window banged open.",
          "WHOOOOM!",
          "Wind filled the carpet like a sail. It swung high above the carpet hall—with the kitten clinging to its fringe.",
          '“Hold on!” Hakan cried.',
        ],
        image: "assets/cats-flying-carpet-kittens-page-01.webp",
        alt: "Lokum sneezing from a pepper basket and pouncing onto a four-rope display carpet as Hakan and Yusuf react in the Grand Bazaar",
      },
      {
        title: "Three Ropes Left",
        paragraphs: [
          "SNAP!",
          "One support rope whipped free. Three ropes held the billowing carpet.",
          "The kitten scrambled toward a deep fold instead of the nearest edge.",
          '“Why is he going back?” Yusuf asked.',
          "Another gust shoved the carpet toward the painted ceiling.",
          'A carpet seller pointed to a railed upper gallery. “You can reach him from there—but if the last rope tears, the whole carpet falls.”',
          "Hakan was already running for the stairs.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-02.webp",
        alt: "Lokum clinging to the billowing display carpet as one broken rope leaves three and a seller points the brothers toward a railed gallery",
      },
      {
        title: "The Safe Way Up",
        paragraphs: [
          "Koray and the sellers cleared everyone from the floor. Angela helped spread a thick pile of soft rugs beneath the swinging carpet.",
          '“Stay behind the gallery railing,” Koray called.',
          "Hakan and Yusuf raced up the wide stairs. A carpet seller checked the railing and stayed beside them. He handed them a long, light display pole. A padded spice basket was tied firmly and kept level at its end.",
          '“A kitten-sized rescue basket,” Hakan said.',
          "Above them, the carpet groaned.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-03.webp",
        alt: "A carpet seller checking the upper-gallery railing and giving Hakan and Yusuf a long pole with a padded basket while adults clear the hall below",
      },
      {
        title: "He Will Not Leave",
        paragraphs: [
          "From behind the railing, Hakan held out the padded basket. Yusuf braced the pole beside him.",
          '“Come on, tiny one,” Hakan whispered.',
          "The kitten sniffed the basket. One paw stepped in.",
          'Then a squeaky “Mew!” came from inside the carpet fold.',
          "The orange kitten spun around and vanished back into it.",
          "SNAP!",
          "A second rope broke. Two ropes left.",
          "The carpet sailed toward the opposite gallery.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-04.webp",
        alt: "Lokum turning away from the rescue basket toward a squeak inside the carpet fold as a second rope breaks",
      },
      {
        title: "Slipper Lane",
        paragraphs: [
          '“Other side!” Yusuf shouted.',
          "The brothers and the carpet seller raced around the safe gallery, through a lane bright with slippers.",
          "WHOOSH! The wind tossed one red slipper onto Yusuf’s arm.",
          '“Not my size,” he puffed, still running.',
          "Hakan laughed—until the carpet swung past their new balcony too quickly to reach.",
          "Beside the next balcony hung a small blunt display hook. Yusuf watched the carpet’s tassels rise, fall, and rise again.",
          '“It has a pattern,” he said. “High. Low. Near.”',
        ],
        image: "assets/cats-flying-carpet-kittens-page-05.webp",
        alt: "The brothers and seller hurrying through Slipper Lane as a red slipper lands on Yusuf and he studies the carpet swing",
      },
      {
        title: "The Twisting Carpet",
        paragraphs: [
          '“High… low… near!” Yusuf called.',
          "The carpet swept closer. Hakan raised the basket.",
          "But one tassel caught on a ceiling hook.",
          "The carpet twisted like a giant spinning top. The hook flung it free.",
          "SNAP!",
          "A third rope broke. One rope left.",
          "The orange kitten flattened himself across the deep fold. He was not trying to escape.",
          "He was guarding it.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-06.webp",
        alt: "The giant carpet twisting on its final rope while Lokum lies protectively across the hidden fold and the boys watch behind a railing",
      },
      {
        title: "The Smaller Secret",
        paragraphs: [
          "Two round gray eyes peeked from the fold.",
          "Inside lay an even tinier smoke-gray kitten. Her paw was tangled in loose fringe.",
          '“That is why he would not leave,” Hakan said. “He stayed for her.”',
          "The orange kitten tugged the fringe, but the knot tightened. The gray kitten squeaked.",
          "Yusuf studied the swing, the basket, and the last rope.",
          '“We need both kittens—and only one more near swing.”',
        ],
        image: "assets/cats-flying-carpet-kittens-page-07.webp",
        alt: "Mercimek revealed inside the carpet fold with one paw tangled while Lokum protects her and Hakan understands why he stayed",
      },
      {
        title: "One Basket, Two Kittens",
        paragraphs: [
          "Hakan slipped off his soft blue hoodie and tucked it into the basket. The seller tied the small blunt hook beside its opening.",
          '“Soft and warm. Big enough for both of you.”',
          "They moved to the wide center balcony, always behind its railing.",
          "Below, the empty floor was ready. Above, the final rope creaked.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-08.webp",
        alt: "Hakan lining the rescue basket with his blue hoodie as the seller attaches a blunt hook and Yusuf studies the final swing",
      },
      {
        title: "The Choice to Wait",
        paragraphs: [
          '“High… low… NEAR!” Yusuf called.',
          "Keeping both feet back, Hakan turned the long pole. Its blunt hook lifted the fringe loose.",
          "The gray kitten was free—but she froze.",
          "Hakan wanted to reach. He stopped himself.",
          "He lowered his voice instead.",
          '“You do not have to jump alone.”',
          "The orange kitten touched noses with his sister. The carpet swung away before either kitten moved.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-09.webp",
        alt: "Hakan safely using the pole-mounted hook to free Mercimek while Lokum touches noses with her and Yusuf calls the swing",
      },
      {
        title: "The Tiny Push",
        paragraphs: [
          "The last rope made a tearing sound.",
          "RRRIP… RRRIP…",
          '“It will come near once more,” Yusuf said. “Trust the pattern.”',
          "High. Low. Near.",
          "The orange kitten climbed into the blue-lined basket. Then he turned back and touched noses with his sister.",
          "The gray kitten squeaked. She lifted one brave paw, then another, and climbed in by herself.",
          "Two tiny tails disappeared safely below the basket rim.",
          "The rope tore halfway through.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-10.webp",
        alt: "Mercimek choosing to climb into the blue-lined basket beside Lokum as the final support rope begins to tear",
      },
      {
        title: "Lift!",
        paragraphs: [
          '“NOW!” Yusuf shouted.',
          "Together, the brothers drew the pole inward. The seller kept the basket level until it cleared the railing and settled on the safe gallery floor.",
          "SNAP!",
          "The last rope broke.",
          "The empty carpet floated down onto the mountain of rugs with a tremendous—",
          "FWOOMP!",
          "The gray kitten burrowed into Hakan’s hoodie. The orange kitten popped up, sneezed pepper onto Yusuf’s red slipper, and looked extremely pleased.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-11.webp",
        alt: "The brothers and seller bringing both kittens safely over the railing as the empty carpet drops onto the soft rugs below",
      },
      {
        title: "Twice as Brave",
        paragraphs: [
          "The carpet sellers cheered from below. Angela and Koray hurried up only after the carpet lay still.",
          'Hakan held the kittens close. “This peppery one is Lokum. The little gray one is Mercimek.”',
          "Mercimek gave one squeaky mew. Lokum washed her ear.",
          '“Two kittens means twice the trouble,” Yusuf said.',
          'Hakan smiled. “And twice as brave.”',
          "That evening, Lokum and Mercimek curled together between the brothers on Hakan’s blue hoodie.",
          "A new team had found them.",
        ],
        image: "assets/cats-flying-carpet-kittens-page-12.webp",
        alt: "Hakan and Yusuf cuddling Lokum and Mercimek on the safe gallery after the empty carpet has landed",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Galata Storm Nest",
    libraryKicker: "Tiny Paws, Big Istanbul — Book 2",
    readerKicker: "A Galata storm rescue with three rising colors",
    readerLayout: "compact-text",
    description:
      "A stolen fish, a hidden fledgling, and a storm route only the brothers and two tiny kittens can solve.",
    cover: "assets/book-cover-cats-galata-storm-nest.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Galata Storm Nest showing the brothers and tiny kittens helping a gull family before a storm near Galata Tower",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "The Fish Thief",
        paragraphs: [
          "Lokum sniffed Hakan's paper cone of grilled fish.",
          '“Pff-CHOO!”',
          "Mercimek squeaked. Hakan laughed.",
          "SWOOP!",
          "A gull snatched the biggest strip and flew above the café's high stone wall.",
          "Over Galata, the blue band of a tall storm flag snapped awake. Gold and red still hung quiet.",
          '“When red flies, everyone goes under cover,” Koray said.',
          "The gull did not swallow the fish. She carried it whole.",
        ],
        image: "assets/cats-galata-storm-nest-page-01.webp",
        alt: "A gull stealing Hakan's largest fish strip on a safe Galata café terrace while Lokum sneezes and only the blue storm band flies",
      },
      {
        title: "The Wrong Turn",
        paragraphs: [
          "Lokum and Mercimek dashed through the terrace's open safety gate. Hakan and Yusuf followed on the broad, walled walk.",
          "Angela and Koray stayed where they could see them. Café keepers watched the gates ahead.",
          "Yusuf tracked the gull past a chimney, a blue dome, and a stone arch.",
          '“Straight ahead!”',
          "They rounded the arch.",
          "Nothing.",
          "Above them, wings flapped the other way. The gull had doubled back.",
        ],
        image: "assets/cats-galata-storm-nest-page-02.webp",
        alt: "Hakan, Yusuf, Lokum, and Mercimek discovering that the gull doubled back above a broad high-walled Galata walk",
      },
      {
        title: "Lokum Knows",
        paragraphs: [
          "The roof walk split beneath two covered arches.",
          "Yusuf searched the sky. Hakan searched the walls. No gull.",
          "Lokum sniffed right, then left. Beside the left arch lay one silver fish scale dusted with pepper.",
          '“Pff-CHOO!”',
          "He raced left. Mercimek and the brothers followed.",
          "At the next walled lookout, the gull launched again—still carrying most of the fish.",
          "The blue flag band cracked in the growing wind.",
        ],
        image: "assets/cats-galata-storm-nest-page-03.webp",
        alt: "Lokum finding a pepper-dusted fish scale at the left covered arch while the gull escapes with the fish and the blue band flies",
      },
      {
        title: "The Uneaten Fish",
        paragraphs: [
          "The gold band joined the blue above Galata.",
          "From behind a glass storm screen, the team watched the gull land on another enclosed terrace. A messy pile of fallen twigs lay beside a thick chimney.",
          "The gull dropped the fish. She tore off one tiny bite—but did not eat it.",
          "Then she vanished behind the chimney.",
          'Yusuf frowned. “She is hiding our lunch.”',
          "From the twigs came a faint answer.",
          '“Peep!”',
        ],
        image: "assets/cats-galata-storm-nest-page-04.webp",
        alt: "The team watching safely through glass as the gull tears a bite from the fish beside fallen nest twigs while blue and gold bands fly",
      },
      {
        title: "Mercimek Says Stop",
        paragraphs: [
          "Lokum crouched, ready to charge through the next open gate.",
          "Mercimek stepped in front of him.",
          "She planted both tiny gray paws.",
          '“Mew!”',
          'A smaller “Peep!” answered through a low rain vent.',
          "Mercimek turned one ear toward it and squeaked again.",
          'Hakan knelt safely on the terrace floor. “She hears someone.”',
          "The kittens waited with him. Together, they moved slowly to the next viewing screen and stayed behind the glass.",
        ],
        image: "assets/cats-galata-storm-nest-page-05.webp",
        alt: "Mercimek stopping Lokum at a safe gate and listening to a faint peep through a rain vent while Hakan kneels nearby",
      },
      {
        title: "Not a Thief",
        paragraphs: [
          "Behind the chimney crouched a gray-brown fledgling—a young gull not ready to fly. It was frightened but unhurt beside its storm-damaged nest.",
          "The mother gull laid the stolen fish before it and tore off a bite.",
          "Gold streamed hard beside blue. Red tugged at the flagpole but did not rise.",
          '“She was not stealing for herself,” Hakan said.',
          'Yusuf nodded. “Forget the lunch. We need to get them under cover.”',
        ],
        image: "assets/cats-galata-storm-nest-page-06.webp",
        alt: "The mother gull feeding her frightened unhurt fledgling beside a storm-damaged nest as Hakan and Yusuf understand from behind glass",
      },
      {
        title: "The Long Safe Way",
        paragraphs: [
          "From two protected windows, Yusuf studied the terrace.",
          "The shortest path to a dry stone alcove crossed a roaring gap between two walls.",
          "The longer path curved behind the chimney. High walls sheltered every step.",
          'Yusuf traced it: “Blue drain tile. Chimney bend. Alcove.”',
          'Hakan watched the young gull. “It watches its mother—not the fish.”',
          "Before the rescue began, Angela settled both kittens behind the closed glass screen. Everyone would keep a safe distance from the birds.",
        ],
        image: "assets/cats-galata-storm-nest-page-07.webp",
        alt: "Yusuf mapping a longer high-walled route from protected windows to a dry stone alcove while Hakan watches the gull family",
      },
      {
        title: "The Little Trail",
        paragraphs: [
          "The mother flew to the far chimney. The fledgling hid behind the stone divider. A keeper checked the sheltered path, opened the gate, and stayed between the boys and the birds.",
          "Hakan and Yusuf placed the remaining fish pieces along Yusuf's route. Then they returned behind the glass, and the keeper closed it.",
          "The mother landed at the blue tile and took one piece.",
          "One wobble. Two hops. The fledgling followed around the chimney bend.",
          '“It is working!” Hakan whispered.',
        ],
        image: "assets/cats-galata-storm-nest-page-08.webp",
        alt: "The gull and fledgling following a fish trail around a sheltered chimney bend after the boys and café keeper retreat behind glass",
      },
      {
        title: "Almost Safe",
        paragraphs: [
          "The mother gull stepped into the dry alcove.",
          "The fledgling reached the doorway.",
          "Everyone smiled.",
          "BOOOOM!",
          "Thunder boomed against a metal chimney cover. The mother flapped up to the far chimney cap. The startled young gull scurried into a narrow covered passage—still safely behind high walls, but out of sight.",
          "The fish trail was gone.",
          "On the storm flag, the red band twitched once… then twice.",
          "Rain tapped the glass.",
        ],
        image: "assets/cats-galata-storm-nest-page-09.webp",
        alt: "Thunder scattering the mother gull and fledgling at the alcove as the red storm band begins to twitch and the team watches behind glass",
      },
      {
        title: "Two Tiny Clues",
        paragraphs: [
          "Blue and gold snapped hard. Red lifted only halfway.",
          "A gust flipped the crumpled fish cone across the enclosed gallery. Lokum pounced and pinned it.",
          "Under his paws lay one last morsel.",
          "He sniffed it, sighed, and pushed it to Hakan.",
          "Mercimek listened at two rain vents. The right one boomed. At the quiet left vent, she squeaked.",
          '“Peep!” came the answer.',
          'Yusuf traced the safe route backward. “The covered passage comes out behind the alcove!”',
        ],
        image: "assets/cats-galata-storm-nest-page-10.webp",
        alt: "Lokum giving Hakan the last fish morsel while Mercimek hears the fledgling at the quiet left vent and the red band rises halfway",
      },
      {
        title: "Follow Her",
        paragraphs: [
          '“The young gull will follow its mother,” Hakan said.',
          "With the keeper beside them, the brothers followed the covered, high-walled walk. Yusuf guided Hakan to the doorway. Hakan set Lokum's last morsel inside. They returned behind glass before the birds moved.",
          "The mother carried the morsel deeper and called.",
          "From behind the alcove came one peep, two quick hops—and the fledgling hurried safely to her.",
          "Over Galata, red joined blue and gold.",
          "Rain lashed outside. Everyone was already under cover.",
        ],
        image: "assets/cats-galata-storm-nest-page-11.webp",
        alt: "The fledgling following its mother into the dry alcove after the team retreats behind glass as all three storm bands fly",
      },
      {
        title: "The Storm Nest",
        paragraphs: [
          "Inside, Hakan cuddled the kittens. Yusuf watched through rain-streaked glass.",
          "Above Galata, three flag bands drooped wet and quiet.",
          "Across the terrace, the mother gull sheltered her fledgling in the dry alcove—their storm nest.",
          "Mercimek squeaked. The fledgling peeped. The mother gull cawed softly.",
          'Lokum answered with an enormous “Pff-CHOO!”',
          "Angela brought two replacement fish. Lokum put one paw on both, sighed, and pushed one to his sister.",
          "Three voices and one enormous sneeze filled the storm—and everyone was safe.",
        ],
        image: "assets/cats-galata-storm-nest-page-12.webp",
        alt: "Hakan and Yusuf cuddling Lokum and Mercimek behind rain-streaked glass while the gull family rests safely in its dry storm nest",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Topkapı Peacock Race",
    libraryKicker: "Tiny Paws, Big Istanbul — Book 3",
    readerKicker: "A flower-parade rescue before the final drum",
    readerLayout: "compact-text",
    description:
      "A racing peahen, a hidden chick, and one drumroll for four rescuers to stop.",
    cover: "assets/book-cover-cats-topkapi-peacock-race.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Topkapı Peacock Race showing the brothers and tiny kittens rescuing a peachick beside a stopped flower-peacock pavilion",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "Feathers Through Flowers",
        paragraphs: [
          "For one magical festival, Topkapı's outer gardens sparkled with paper tulips. A peacock pavilion waited on four golden wheels.",
          "BOOM! First call.",
          "Above the drummers, the first of three tulip lanterns glowed.",
          "A real brown peahen burst through a rose arch.",
          "WHOOSH! Paper tulips flew. A puppet feather tumbled across the path and flopped across Yusuf's face.",
          "Lokum landed in carnations.",
          '“Pff-CHOO!”',
          "Petals showered Mercimek.",
          "The peahen ignored a bowl of grain, called “KEE-OW!” and raced straight toward the pavilion.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-01.webp",
        alt: "A peahen bursting through paper flowers toward the stopped pavilion as Lokum sneezes petals, a puppet feather lands on Yusuf, and one lantern glows",
      },
      {
        title: "The Festival Rule",
        paragraphs: [
          "A keeper swung the garden gate closed.",
          '“Stay on the wide path,” she said. “Don\'t chase her. We must guide her to the quiet garden before the last drum.”',
          "At a signal post, a festival helper crossed two tulip flags. Every drummer stopped.",
          '“Flags crossed—everything stops!” the children called.',
          '“If you see trouble, copy the X with your festival fans.”',
          "Yusuf studied the shape.",
          "Ahead, the peahen cried again, then tilted her head and waited for an answer.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-02.webp",
        alt: "Yusuf studying the crossed tulip-flag stop signal while the family stays on the broad visitor path and the peahen listens ahead",
      },
      {
        title: "Kitchen Snowstorm",
        paragraphs: [
          "The peahen dashed into the festival kitchen court.",
          "A baker lifted his flour cloth out of her way.",
          "FWOOM!",
          "White flour puffed harmlessly over the paving. Lokum popped out wearing a parsley moustache.",
          "Hakan offered the open path toward the quiet garden. A keeper set grain far ahead.",
          "The peahen took one step toward it.",
          "Then she called, listened, and bolted back toward the pavilion.",
          'Yusuf wiped flour from his nose. “She isn\'t lost,” he said. “She knows the way.”',
        ],
        image: "assets/cats-topkapi-peacock-race-page-03.webp",
        alt: "A harmless flour puff in the kitchen court as Lokum wears a parsley moustache and the peahen ignores grain to return toward the pavilion",
      },
      {
        title: "Two Kinds of Tracks",
        paragraphs: [
          "Around the flower courtyard, every turn brought the peahen back to the painted pavilion.",
          "From behind the visitor rail, Lokum crouched near a fallen tassel.",
          "Mercimek did not chase it. She sniffed where his sneeze had blown petals aside.",
          "Two kinds of tracks crossed the blue tiles: large prints circled the pavilion. Tiny three-toed prints went beneath its flowered skirt—and never came out.",
          "The peahen lowered her head toward the shadow and cried, “KEE-OW!”",
          "Mercimek's ears twitched. Something had answered.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-04.webp",
        alt: "Mercimek finding tiny chick tracks beneath the pavilion skirt while larger peahen tracks circle outside and the family stays behind the visitor rail",
      },
      {
        title: "The Smallest Answer",
        paragraphs: [
          "BOOM-BOOM! Second call. The second tulip lantern glowed.",
          "The peahen raced to the far side. Keepers held the safety rope. The boys and kittens stayed back.",
          "From behind the rope, Mercimek faced one low opening.",
          '“Mew?”',
          'From beneath the still pavilion came a faint “Peep!”',
          "Lokum stopped mid-pounce. Hakan knelt outside the line.",
          "No hands went underneath. A keeper slid in a mirror on a long stick.",
          "Inside the mirror, one round dark eye blinked.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-05.webp",
        alt: "Mercimek calling from behind the safety rope while a keeper uses a long-handled mirror and two of three tulip lanterns glow",
      },
      {
        title: "Not a Race",
        paragraphs: [
          "One frightened—but unhurt—chick crouched beneath the pavilion.",
          "The racing peahen was its mother.",
          '“She wasn\'t making trouble,” Hakan said. “She was searching.”',
          "A keeper locked the wheels, checked four chocks, and hung a red STOP sign. Angela and Koray helped families move behind the rail.",
          "But the final drums would start every other cart—and terrify the chick.",
          "Yusuf looked toward the faraway signal flags.",
          '“Then we have two jobs,” he said. “Stop the parade and help the chick come out.”',
        ],
        image: "assets/cats-topkapi-peacock-race-page-06.webp",
        alt: "The keeper revealing the unhurt chick beneath the locked chocked pavilion as Hakan understands and Yusuf studies the distant signals",
      },
      {
        title: "One Safe Way",
        paragraphs: [
          "Standing behind the rope, Hakan looked around the pavilion. Two openings faced the wheels. The wide opening at the back faced tiles.",
          '“That\'s the safe way,” he said. “And nobody reaches inside.”',
          "A keeper opened the path and placed a see-through flower fence beside it. The kittens could be heard but could not reach the birds.",
          "An adult called. The chick shrank deeper into shadow.",
          "Mercimek squeaked. The chick peeped back.",
          "Hakan smiled.",
          '“Soft paws. Soft voices. One safe step.”',
        ],
        image: "assets/cats-topkapi-peacock-race-page-07.webp",
        alt: "Hakan choosing the wide wheel-free rear opening while a keeper secures a see-through flower fence and Mercimek's squeak earns a peep",
      },
      {
        title: "The Giant Eye",
        paragraphs: [
          "Behind the flower fence, Mercimek chose to squeak again.",
          "The chick turned toward her.",
          "Lokum ignored the wild puppet tassel above his head. He lay beside his sister and made his smallest “Mrrp.”",
          "One shuffle. Two shuffles.",
          "The chick's beak appeared.",
          "Then the pavilion's huge painted peacock eye swung in the wind.",
          '“Peep!” The chick backed into shadow.',
          '“Big things scare it,” Hakan said. A keeper tied the eye-panel flat.',
          '“Try again. Soft paws. Soft voices. One safe step.”',
        ],
        image: "assets/cats-topkapi-peacock-race-page-08.webp",
        alt: "The chick retreating safely when the giant painted peacock eye swings as the kittens call behind the flower fence and the keeper secures the panel",
      },
      {
        title: "One Foot Out",
        paragraphs: [
          "The kittens called again. The chick followed the path and put one yellow foot onto the tiles.",
          "Everyone smiled.",
          "Then the mother spotted two kittens through the fence.",
          '“KEE-OW!” she cried in alarm.',
          "The chick scurried back into shadow.",
          "Rrrrrrrrr…",
          "The final drumroll began. Performers gripped ropes. The tall pavilion hid the rescue from the lead drummer.",
          "The dark third lantern flickered.",
          "Yusuf spotted the marked safety post across the broad tiled arcade.",
          '“I have one drumroll,” he said.',
        ],
        image: "assets/cats-topkapi-peacock-race-page-09.webp",
        alt: "The mother peahen alarming at visible kittens so the chick retreats during the final drumroll while the third lantern flickers dark and Yusuf sees the safety post",
      },
      {
        title: "Cross the Flags!",
        paragraphs: [
          "Yusuf ran along the wide visitor lane during the drumroll.",
          "He reached the safety post. The drummer raised both sticks.",
          "Yusuf lifted his blue-and-gold fans and crossed them as the festival helper had shown.",
          '“FLAGS CROSSED—EVERYTHING STOPS!”',
          "One signaler saw the X, checked the pavilion's bright STOP sign, and crossed two tulip flags. Another copied it.",
          "The drumsticks froze before the final BOOM. The third lantern stayed dark.",
          "Every drum fell silent. Every wheel stayed chocked and still.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-10.webp",
        alt: "Yusuf crossing blue and gold fans at the safety post as official tulip flags form an X and the drummer freezes before the final boom",
      },
      {
        title: "The Quietest Rescue",
        paragraphs: [
          "Hakan had understood the failed rescue.",
          '“The chick needs to hear the kittens. Its mother must not see them.”',
          "A keeper set a solid flower screen beside the fence. It hid the kittens but left the chick's path open. Their tiny voices slipped around it.",
          "Mercimek squeaked. Lokum gave one soft “Mrrp.”",
          '“Soft paws. Soft voices. One safe step,” Hakan whispered.',
          "Peep. Step. Peep. Step.",
          "The chick toddled out.",
          "Its mother called—and folded one warm wing around it.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-11.webp",
        alt: "The hidden kittens' quiet calls guiding the chick through the wheel-free opening to its mother while Hakan and the keeper remain outside",
      },
      {
        title: "The Smallest Rescue Team",
        paragraphs: [
          "Keepers stood back while mother and chick walked into the garden. They checked the pavilion, route, wheels, and area.",
          "Only then did the third tulip lantern glow, the flags open, and the flower procession roll.",
          '“Lokum and Mercimek—Istanbul\'s Smallest Rescue Team!” announced the parade leader.',
          '“Four rescuers,” Hakan corrected.',
          '“Two of us are not especially small,” Yusuf said.',
          "Mercimek squeaked. The chick peeped.",
          "Lokum bowed—and sneezed his paper crown onto Yusuf.",
          "The flower peacock bowed too.",
          "This time, Yusuf ducked.",
        ],
        image: "assets/cats-topkapi-peacock-race-page-12.webp",
        alt: "The all-clear flower procession with three glowing lanterns as Lokum sneezes his crown toward Yusuf and the peahen and chick watch from the quiet garden",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Giant Miniature City",
    libraryKicker: "Istanbul's Impossible Games — Book 1",
    readerKicker: "A tiny race against one giant shadow",
    readerLayout: "compact-text",
    description:
      "A sneeze shrinks four rescuers, and one bossy game refuses to let anyone win alone.",
    cover: "assets/book-cover-cats-giant-miniature-city.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Giant Miniature City showing the tiny brothers and kittens turning the guarded Rule Spinner together",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "The Sneeze That Shrunk Them",
        paragraphs: [
          "At Istanbul's miniature-city park, a guide led them onto a padded mat inside a closed rail. Domes, towers, ferries, and bridges filled the garden.",
          "She set a top beside a silver groove into the model streets.",
          '“The Rule Spinner chooses how teams play,” she said.',
          "Lokum sniffed its red arrow.",
          '“No sneeze,” Yusuf warned.',
          '“Pff-CHOO!”',
          "WHIRRR!",
          "The models shot upward. Angela, Koray, and the guide grew taller than minarets.",
          "Hakan stared at his finger-sized shoes.",
          "The four rescuers had shrunk.",
        ],
        image: "assets/cats-giant-miniature-city-page-01.webp",
        alt: "Lokum sneezing beside the Rule Spinner as Hakan, Yusuf, and both kittens shrink safely on the padded mat",
      },
      {
        title: "Before the Shadow Lands",
        paragraphs: [
          "The Spinner zipped down the groove and stopped twelve streets inside the closed zone.",
          "The light lifted Hakan, Yusuf, Lokum, and Mercimek onto a START square.",
          "Outside, Angela and Koray helped the guide close the path. Every mechanism stopped. The team was safe—but tiny.",
          "A sundial shadow crossed twelve red marks toward the Spinner.",
          '“When it reaches the arrow, this size rule locks until morning!” the guide called.',
          "Yusuf counted streets.",
          "Hakan tightened his hoodie.",
          '“Then we move together.”',
        ],
        image: "assets/cats-giant-miniature-city-page-02.webp",
        alt: "The finger-sized team on the start square as a sundial shadow begins crossing twelve red marks toward the distant Spinner",
      },
      {
        title: "Hakan's Little Door",
        paragraphs: [
          "The first street ended at a model stone arch.",
          '“I will go first,” Yusuf said.',
          "The Spinner jerked.",
          "Its red arrow clicked faster.",
          "Yusuf tried the narrow opening. His shoulders stuck.",
          "Hakan slipped through beside him. A soft paper game gate rested against one hinge.",
          '“You cannot fit,” he said. “But I can open your way.”',
          "He pushed the light gate outward. Yusuf stepped through the wider side.",
          "The arrow slowed.",
          "Mercimek gave one pleased squeak.",
          "The game was listening.",
        ],
        image: "assets/cats-giant-miniature-city-page-03.webp",
        alt: "Small Hakan opening a soft paper side gate after Yusuf gets harmlessly stuck at the narrow model arch",
      },
      {
        title: "A Feather Like a Tent",
        paragraphs: [
          "The Spinner's faster whir shook a striped felt feather loose from a game awning.",
          "FLUMP!",
          "It covered the team like a soft tent.",
          "Lokum pounced.",
          '“Pff-CHOO!”',
          "The feather lifted one handspan with Lokum riding it like a fuzzy flag.",
          "Hakan caught its stem. Yusuf grabbed Hakan's jacket.",
          "Mercimek squeaked before the draft carried it into a dead-end street.",
          "Together they tugged it onto a padded lane.",
          "Lokum stepped off wearing an enormous fluff moustache.",
          "The shadow reached red mark three.",
        ],
        image: "assets/cats-giant-miniature-city-page-04.webp",
        alt: "The tiny team tugging a soft felt feather onto the padded lane while Lokum rides it with a comic fluff moustache",
      },
      {
        title: "The Street That Would Close",
        paragraphs: [
          "The feather's tip brushed a silver sensor.",
          "Ahead, blue silk fountain ribbons swept the short avenue like slow curtains.",
          "The shadow reached mark five.",
          '“That way is fastest,” Hakan said.',
          "Yusuf watched the ribbons and shadow.",
          '“Only at first. They meet before we arrive. Then the game locks the street.”',
          "He traced a longer covered-market lane.",
          '“Your map,” Hakan said. “My small doors.”',
          "The Spinner slowed.",
          "They entered the covered lane together.",
        ],
        image: "assets/cats-giant-miniature-city-page-05.webp",
        alt: "Yusuf choosing the longer open market lane as blue silk ribbons begin closing the tempting short model street",
      },
      {
        title: "Bigger, Smaller, Worse",
        paragraphs: [
          "The lane narrowed.",
          'Yusuf pointed. “Stay behind me. I decide.”',
          "CLICK!",
          "The warning changed their sizes. Yusuf shrank to Lokum's ear height. Hakan grew as tall as a shop awning.",
          '“Now I am the big brother!” Hakan laughed.',
          "CLICK-CLICK!",
          "Their sizes swapped. The Rule Spinner raced.",
          "Mercimek squeaked. Both boys fell quiet.",
          '“It swaps us when one person acts like the boss,” Yusuf said.',
          'Hakan held out his hand. “Then nobody is the boss.”',
          'Yusuf took it. “We choose together.”',
        ],
        image: "assets/cats-giant-miniature-city-page-06.webp",
        alt: "The Rule Spinner comically swapping Hakan and Yusuf's sizes until the brothers reach for each other's hands",
      },
      {
        title: "Team Words Only",
        paragraphs: [
          '“No more boss words,” Hakan said.',
          '“Team words,” Yusuf agreed.',
          "Their sizes settled back to one steady finger-height.",
          "At each crossing, Hakan chose the opening he could test. Yusuf chose the moment before the shadow reached it.",
          "Lokum waited for Mercimek's squeak before pouncing across each painted line.",
          '“Your space,” said Yusuf.',
          '“Your timing,” said Hakan.',
          "The Spinner's wild whir became a steady hum.",
          "The shadow reached red mark eight.",
          "Only four streets remained.",
        ],
        image: "assets/cats-giant-miniature-city-page-07.webp",
        alt: "Hakan testing a small opening while Yusuf times the crossing and both kittens wait for Mercimek's signal",
      },
      {
        title: "Two Paws Too Soon",
        paragraphs: [
          "The final avenue had two brass pads.",
          "The Spinner waited by a model tower.",
          '“We step together,” Hakan said.',
          "They raised their shoes.",
          "Lokum saw the red arrow and sprang.",
          "Two orange paws landed first.",
          "BOING!",
          "Hakan's padded platform slid along a shallow groove to the Spinner. Behind it, the avenue folded into knee-high paper ridges.",
          "Yusuf and the kittens stayed safe.",
          "The shadow reached mark ten.",
          '“I can reach it!” Hakan cried.',
          "The Spinner began to grow.",
        ],
        image: "assets/cats-giant-miniature-city-page-08.webp",
        alt: "Lokum landing two orange paws too early as Hakan's padded platform slides safely toward the growing Spinner",
      },
      {
        title: "The Almost-Win",
        paragraphs: [
          "From the padded platform, Hakan reached the Spinner's blunt handle.",
          "He caught it with both hands.",
          '“I got it!”',
          "The Spinner ballooned taller.",
          "Across the folded street, Yusuf shrank until he was paw-sized.",
          "Hakan pulled once. The handle turned a finger-width—and Yusuf became smaller.",
          '“Hakan—wait!” Yusuf\'s voice sounded tiny.',
          "The shadow reached the Spinner's silver outer ring.",
          "Hakan could pull and leave Yusuf tiny until morning.",
          "Or he could let go.",
          "He opened his hands.",
          '“Not without you.”',
        ],
        image: "assets/cats-giant-miniature-city-page-09.webp",
        alt: "Hakan releasing the blunt Spinner handle after seeing Yusuf shrink across the low folded model street",
      },
      {
        title: "The Blue Path",
        paragraphs: [
          "The Spinner stopped growing. Yusuf returned to steady size, but knee-high ridges blocked the avenue.",
          "Hakan unzipped his hoodie and spread it along the safest solid folds.",
          '“Blue marks the path,” he called. “The ridges hold us.”',
          "Yusuf pressed each ramp before stepping. Mercimek followed. Lokum came last, shaking with a trapped sneeze.",
          "The shadow covered half the Spinner.",
          "Beyond a guard, two paw plates waited. Each kitten chose one.",
          "Yusuf reached Hakan.",
          '“Now we need both sides.”',
        ],
        image: "assets/cats-giant-miniature-city-page-10.webp",
        alt: "Yusuf and the kittens following Hakan's blue hoodie marker across solid knee-high paper ridges toward the Spinner",
      },
      {
        title: "Turn Together",
        paragraphs: [
          "Yusuf counted notches. Guarded handles matched across the ring.",
          '“Your near handle moves left,” Yusuf said. “Mine moves right. Both turn the ring backward.”',
          "The kittens pressed paw plates. The base locked.",
          "The shadow covered all but the red arrow.",
          '“One,” Yusuf said.',
          "Lokum's nose twitched.",
          '“Two.”',
          "Mercimek squeaked.",
          '“Together!”',
          "The brothers pushed their handles. The ring and arrow spun backward inside the guard.",
          "WHOOSH!",
          "The silver groove carried them to the mat before they grew.",
          "Shoes returned to normal.",
        ],
        image: "assets/cats-giant-miniature-city-page-11.webp",
        alt: "Hakan and Yusuf counter-turning guarded handles while Lokum and Mercimek press the two paw plates",
      },
      {
        title: "No One Too Small",
        paragraphs: [
          "Using a scoop, the guide slid the Spinner into a padded clear box.",
          "CLICK! The lid locked.",
          'Hakan looked across the miniature city. “Your timing.”',
          'Yusuf bumped his shoulder. “Your small doors.”',
          "Mercimek squeaked. Lokum hopped onto the lid.",
          '“On three—no sneezing,” Yusuf said. “One—”',
          '“Pff-CHOO!”',
          "The box stayed locked, but the red arrow spun straight toward Yusuf.",
          "Lokum bowed as if that had been the rule all along.",
        ],
        image: "assets/cats-giant-miniature-city-page-12.webp",
        alt: "Normal-sized Hakan and Yusuf laughing as Lokum sneezes on the locked Spinner box and its red arrow turns toward Yusuf",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Toys Who Wouldn't Sleep",
    libraryKicker: "Istanbul's Impossible Games — Book 2",
    readerKicker: "Eight fading stars and one impossible bedtime",
    readerLayout: "compact-text",
    description:
      "A tin drummer wakes the toy gallery, and every command adds another lap before morning.",
    cover: "assets/book-cover-cats-toys-wouldnt-sleep.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Toys Who Wouldn't Sleep showing the brothers and kittens calming Captain Tıkır's bedtime parade",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "One More Game!",
        paragraphs: [
          "After closing, a guide opened the Moon Toy Gallery's padded play zone.",
          "She unlocked the Rule Spinner.",
          "Lokum sniffed a soft felt moon beside its paw plate.",
          '“No sneeze,” Yusuf said.',
          '“Pff-CHOO!”',
          "The felt moon flipped onto the paw plate.",
          "TIK-ka-TAK! CLATTER-CLACK!",
          "A red tin drummer sat up. A wooden tram rang. Tops wobbled. Cloth animals bounced from low displays.",
          "Silver route-lines lit across one fixed padded floor board.",
          '“No goodnight!” cried the drummer. “Play till sunlight!”',
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-01.webp",
        alt: "Lokum sneezing a felt moon onto the Rule Spinner as Captain Tıkır and the small gallery toys wake inside the padded zone",
      },
      {
        title: "Eight Stars Until Morning",
        paragraphs: [
          "The guide stopped the displays. Angela and Koray guarded the entrance.",
          "Only hand-sized toys moved in the padded zone.",
          "Eight stars glowed overhead. DING! One darkened.",
          "The guide lifted Tıkır with a padded scoop. Silver light returned him to the first circle.",
          '“Only players can finish the Spinner\'s rule. If the last star fades first, tomorrow\'s program cannot open.”',
          'Tıkır pointed at Hakan. “Captain Tıkır\'s bedtime course!”',
          "Yusuf studied. Every path curved back.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-02.webp",
        alt: "The guide's padded scoop lifting Captain Tıkır before silver light returns him to the first circle beneath seven glowing stars",
      },
      {
        title: "Every Order Adds a Lap",
        paragraphs: [
          "Tıkır marched first. Tram, tops, puppets, and cloth animals followed.",
          '“Drummer first! Tram next! Horse behind!” Yusuf called.',
          "CLACK!",
          "A silver loop flashed across the fixed board.",
          "The parade returned behind him.",
          "Behind a low foam lip, Lokum trotted in his kitten lane while the tram rolled beside him.",
          'Around again. “Mrrp?”',
          "Mercimek squeaked each time Lokum passed.",
          "The second star darkened.",
          "Yusuf lowered his hands.",
          '“Every order sounds like another game.”',
          "Captain Tıkır drummed faster.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-03.webp",
        alt: "A new silver loop sending Captain Tıkır's parade back behind Yusuf while Lokum circles safely in a separate kitten lane",
      },
      {
        title: "Beat the Bedtime Course",
        paragraphs: [
          '“Then we beat the course,” Hakan said.',
          'Yusuf counted under his breath. “Two steps… it stops… now.”',
          "The tram locked on its foam circle until they crossed. Puppets lowered short soft ribbons across the toy lanes.",
          "Hakan flattened one lightweight foam gate with a finger while the brothers stayed on the padded walking strip.",
          "The kittens pressed two floor pads.",
          "The final gate opened.",
          "Hakan and Yusuf crossed together.",
          "Five stars remained.",
          "Every toy froze.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-04.webp",
        alt: "Hakan flattening a finger-high foam gate while Yusuf times the stopped tram and both kittens press floor pads",
      },
      {
        title: "The Last-Toy-Home Race",
        paragraphs: [
          '“We won!” Hakan cheered.',
          "Captain Tıkır's drumsticks drooped.",
          "Hakan changed his shout into a question.",
          '“Who wants to race to a favorite resting place?”',
          "Every toy bounced.",
          "Yusuf straightened one section of board and marked safe pauses with three colored circles.",
          "The tram rolled toward its harbor cubby. A cloth horse trotted toward a velvet stable. Tops spun toward round nests.",
          "The Spinner slowed.",
          "Four stars remained.",
          "The gallery grew quiet.",
          '“Goodnight,” Hakan whispered.',
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-05.webp",
        alt: "Hakan inviting the toys to race toward open resting places along Yusuf's three colored pause circles",
      },
      {
        title: "What Goodnight Means",
        paragraphs: [
          "Captain Tıkır's painted eye popped open.",
          '“Goodnight means shut away. Forgotten!”',
          "TIK-ka-TAK! CLATTER-CLACK!",
          "The toys tumbled back. Silver arrows lit a tighter loop across the fixed board.",
          "Hakan stopped chasing.",
          "Tıkır pointed toward a dark storage curtain.",
          '“I waited behind that for a season.”',
          "Mercimek chose an open velvet cubby and curled up. Hakan answered her squeak at once.",
          '“You rested. I remembered.”',
          "The Spinner slowed. Tıkır lowered a stick.",
          '“Prove stories can return.”',
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-06.webp",
        alt: "Captain Tıkır pointing toward the dark storage curtain while Hakan answers Mercimek in her bright open cubby",
      },
      {
        title: "A Story With Tomorrow",
        paragraphs: [
          "Hakan sat by the board.",
          '“Tonight, each toy chooses one brave thing. Tomorrow, the next chapter begins.”',
          "The silent toys answered with gestures.",
          "The tram faced its harbor. The horse nudged its stable. A top bowed toward its round velvet nook.",
          'Tıkır raised both sticks. “I choose my last brave thing too.”',
          "But resting places stood beyond the endless circle.",
          "Yusuf turned one loose foam tile.",
          "The loop opened.",
          '“Then the story needs a new path.”',
          "Three stars remained.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-07.webp",
        alt: "Hakan offering the toys a continuing story while Yusuf turns one loose foam route tile toward their chosen cubbies",
      },
      {
        title: "The Bedtime Parade",
        paragraphs: [
          "Yusuf made one gentle route past every chosen resting place.",
          'The toys nodded to Yusuf\'s pause rhyme: “Step-step—STOP. Choose—then PLOP.”',
          "The tram rang and paused. The horse bowed. A puppet lowered one ribbon bridge.",
          "Every toy rushed for one last turn.",
          "JAM!",
          "Lokum missed the pause and plopped into a patchwork bear's lap.",
          "Next in line, Mercimek squeaked.",
          "The line moved.",
          "Hakan gave each toy one story sentence. Yusuf gave each toy one safe gap.",
          "Two stars remained.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-08.webp",
        alt: "The bedtime parade forming a comic padded jam as Lokum lands backward in a patchwork bear's lap",
      },
      {
        title: "The Too-Early Ending",
        paragraphs: [
          "CLATTER-CLACK softened to clink-clink.",
          "WHIZZLE-WHIRR softened to whish.",
          'At every pause, Hakan promised, “Your turn is done. Your story is not.”',
          "The tram rested. The horse nestled down. The top spun once into its nook.",
          "Captain Tıkır reached the final tile.",
          "Only one star shone.",
          'Hakan smiled. “The end.”',
          'Captain Tıkır gasped. “No tomorrow?”',
          "Every toy's eyes popped open.",
          "The silver route-lines flashed back into a giant loop.",
          "TIK-ka-TAK!",
          "The last star flickered.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-09.webp",
        alt: "Captain Tıkır gasping at Hakan's too-early ending as every toy wakes and the silver route flashes into a giant loop",
      },
      {
        title: "No Endless Promise",
        paragraphs: [
          "Hakan could promise forever.",
          "But it would not be true.",
          "He did not grab Captain Tıkır's sticks or order him into place.",
          "He sat beside the bright front cubby.",
          '“Not the end—a pause before tomorrow.”',
          "He gave tomorrow's chapter one opening line:",
          '“Captain Tıkır will discover what hides behind the moon-shaped door…”',
          "Then he stopped before the answer.",
          "Tıkır's drumbeat slowed.",
          "Yusuf studied the final bend.",
          '“We must tell and time it together.”',
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-10.webp",
        alt: "Hakan pausing tomorrow's moon-door story beside Tıkır's bright cubby while Yusuf studies the final bend",
      },
      {
        title: "Story, Pause, Turn!",
        paragraphs: [
          "The last star dimmed.",
          "Hakan narrated each final brave action while holding the near padded handle.",
          "Yusuf held the far handle, calling each pause.",
          '“Step-step—STOP!”',
          "The toys performed, then settled into open cubbies.",
          "Lokum and Mercimek pressed the paw plates.",
          "Tıkır marched to the bright front cubby himself.",
          '“First beat tomorrow,” he said, laying down his sticks.',
          '“Together!”',
          "They turned the guarded handles.",
          "The arrow spun backward.",
          "CLICK! The board went still as the star vanished.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-11.webp",
        alt: "Hakan and Yusuf turning the guarded handles as both kittens press paw plates and Captain Tıkır settles in his bright cubby",
      },
      {
        title: "Tomorrow Begins",
        paragraphs: [
          "Families entered. Children pointed at the resting toys.",
          "Tıkır opened one eye—remembered.",
          "The guide saved Hakan's story for the morning program and locked the Spinner in its clear case.",
          "Koray unrolled a soft Rumeli Fortress festival banner.",
          "Inside the case, the red arrow turned toward it.",
          "One foam pennant flipped toward the fortress map.",
          "Tap… tap…",
          'Tıkır whispered, “That game never knows when to end.”',
          "Lokum's nose twitched. Tıkır ducked behind his drum.",
        ],
        image: "assets/cats-toys-wouldnt-sleep-page-12.webp",
        alt: "Captain Tıkır ducking behind his drum as Lokum prepares to sneeze and the locked Spinner points toward Rumeli Fortress",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Fortress Game That Wouldn't End",
    libraryKicker: "Istanbul's Impossible Games — Book 3",
    readerKicker: "Six fading pennants and one finish for everyone",
    readerLayout: "compact-text",
    description:
      "A banner maze crowns one winner, resets, and forces the children to invent a finish for everyone.",
    cover: "assets/book-cover-cats-fortress-game.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Fortress Game That Wouldn't End showing the brothers, Derya, and the kittens stopping the Rule Spinner together",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "The Maze Jumps Up",
        paragraphs: [
          "In Rumeli Fortress's lower courtyard, Derya welcomed Hakan and Yusuf to a ground-level game festival.",
          "Koray unrolled the soft banner from the toy gallery.",
          "Its foam pennant pointed at the Rule Spinner.",
          "Lokum sniffed.",
          '“Please don\'t—” Yusuf began.',
          '“Pff-CHOO!”',
          "WHUMP-WHUMP-WHUMP!",
          "Soft banner walls sprang upright across the padded zone. Flags zipped into a maze. A golden horn bounced onto its stand.",
          '“First player to the finish wins!” it boomed.',
          'Derya sighed. “It loves drama.”',
          "Then the finish flag ran away.",
        ],
        image: "assets/cats-fortress-game-page-01.webp",
        alt: "Lokum sneezing beside the Rule Spinner as soft banner walls spring up and Derya watches the finish flag run away",
      },
      {
        title: "Six Pennants Until Sunset",
        paragraphs: [
          "Staff locked the outer rail and checked each soft wall and low gate. The real exit stayed open. Angela and Koray waited there.",
          "Above the game, six purple sunset pennants glowed.",
          "DONG!",
          "One went dark.",
          'Derya grinned. “If the last pennant darkens while the maze runs, tonight\'s family finale cannot open. Let\'s outsmart this noisy game.”',
          "Yusuf studied the maze. Hakan spotted one kitten-sized tunnel.",
          "The finish flag popped up far away.",
          '“Ready?” it squeaked.',
          'The golden horn shouted, “RACE!”',
        ],
        image: "assets/cats-fortress-game-page-02.webp",
        alt: "Derya pointing from five glowing purple pennants to the noisy horn while Yusuf studies the safe flat maze",
      },
      {
        title: "Hakan's Fast Little Gate",
        paragraphs: [
          'Yusuf pointed to a tall blue arch. “That route is shorter.”',
          "Hakan found a low red tunnel—wide for him, too low for Yusuf.",
          '“Mine is smaller.”',
          "He crawled through the padded tunnel. The kittens scampered after him.",
          "Derya called color turns. Yusuf tracked Hakan through banner windows.",
          "Hakan reached the finish flag first.",
          'The horn blasted, “HAKAN WINS!”',
          "Five pennants flashed—then every wall folded flat.",
          "WHUMP!",
          "The maze sprang up differently. Everyone returned to the start.",
        ],
        image: "assets/cats-fortress-game-page-03.webp",
        alt: "Hakan and the two kittens using the broad low red tunnel while Yusuf takes the tall blue arch toward the finish",
      },
      {
        title: "A Win That Starts Again",
        paragraphs: [
          "The finish flag tucked itself under Hakan's arm.",
          "Yusuf and Derya waited behind a new wall.",
          '“Winning left everyone else behind,” Hakan said.',
          "He planted the flag beside the start instead.",
          "The horn sputtered.",
          '“No winner? Then race again!”',
          "Silver arrows raced from the Spinner. Every path doubled.",
          "Lokum chased one arrow in a circle until Mercimek squeaked him dizzy.",
          "DONG! A second pennant darkened.",
          "Yusuf knelt over the route marks.",
          '“I can map one finish for all of us.”',
        ],
        image: "assets/cats-fortress-game-page-04.webp",
        alt: "Hakan planting his winner flag at the start while Yusuf maps doubled silver paths and Lokum chases an arrow",
      },
      {
        title: "Yusuf's Perfect Route",
        paragraphs: [
          "Yusuf chose gates that opened together: tall blue for him, low red for Hakan, two paw flaps for the kittens.",
          "Derya matched each turn with a colored flag.",
          "Step—duck—pounce!",
          "They reached the final lane together.",
          "But the finish strip slid toward Yusuf's longest step.",
          "His gray sneaker crossed first.",
          '“YUSUF WINS!” boomed the horn.',
          "The maze collapsed.",
          "WHUMP! It reset again.",
          "Yusuf dropped the winner's flag.",
          "Four pennants remained.",
          '“My map made one person first,” he said.',
        ],
        image: "assets/cats-fortress-game-page-05.webp",
        alt: "Yusuf's sneaker crossing the sliding finish strip first as the others reach the lane and the maze starts resetting",
      },
      {
        title: "The Rule Under the Rule",
        paragraphs: [
          "Derya caught the flag before it covered Mercimek.",
          "Its silver picture showed one crowned player above a circular maze.",
          '“It keeps asking for one champion,” Derya said. “Bossy game.”',
          "Hakan remembered Captain Tıkır's endless parade.",
          "Yusuf remembered the miniature city's bossy paths.",
          '“One winner means the game never ends,” they said together.',
          "The horn lifted its bell.",
          '“Name my champion!”',
          "Three pennants glowed.",
          'Hakan shook his head. “We need a finish with nobody left behind.”',
        ],
        image: "assets/cats-fortress-game-page-06.webp",
        alt: "Derya revealing a silver crowned-player picture on the flag while Hakan refuses the horn's demand for one champion",
      },
      {
        title: "Tall, Small, Paws",
        paragraphs: [
          "Yusuf drew one route through three gates that opened at the same beat.",
          "He took the tall blue gate. Hakan took the low red one. Lokum and Mercimek chose the paw flaps.",
          "Derya stood where all routes met and waved them together.",
          '“Tall, small, paws—PAUSE!”',
          "They stopped in one wide row before the finish lane.",
          "The horn tried to swing its bell toward Yusuf.",
          "Yusuf handed his winner's flag to Derya.",
          '“No one goes first.”',
          "Two pennants remained.",
        ],
        image: "assets/cats-fortress-game-page-07.webp",
        alt: "Yusuf, Hakan, and both kittens emerging from tall, low, and paw gates as Derya waves them into one row",
      },
      {
        title: "Everybody Across",
        paragraphs: [
          "The finish strip waited in a shallow padded groove.",
          '“One jump,” Hakan said. “Side by side.”',
          "Derya counted. Yusuf matched every foot and paw.",
          '“Three, two, one—WHOOSH!”',
          "Hakan, Yusuf, Derya, Lokum, and Mercimek crossed together.",
          "The horn's cheeks puffed.",
          "It looked left. It looked right.",
          '“Name the winner!”',
          '“Team Istanbul!” they cheered.',
          "The horn blasted.",
          "The maze fell—and sprang up again.",
          "One pennant glowed.",
          'Yusuf groaned. “A team name is still one winning name.”',
        ],
        image: "assets/cats-fortress-game-page-08.webp",
        alt: "All three children and both kittens crossing the finish together just before the baffled horn resets the maze again",
      },
      {
        title: "The Finish That Chased Them",
        paragraphs: [
          "The finish strip skittered through its shallow groove.",
          "Hakan chased one corner. Yusuf blocked the next. Derya lowered two foam gates.",
          "Lokum pounced.",
          "The strip stopped at its soft bumper. Lokum landed on the fixed pad, fluff spread like a tiny rug.",
          "Mercimek squeaked at the Spinner.",
          "Its guarded handles opened. Both paw plates glowed.",
          "The last pennant flickered.",
          "Hakan stopped.",
          '“Why must we cross the finish?”',
          "He grinned at Yusuf.",
          '“What if the finish crosses everybody?”',
        ],
        image: "assets/cats-fortress-game-page-09.webp",
        alt: "The finish strip stopping at its soft bumper before Lokum as Hakan sees the Spinner's handles and gets a new idea",
      },
      {
        title: "One Wide Line",
        paragraphs: [
          "Yusuf traced the strip's groove beneath every gate and back to the start.",
          '“It can reach everyone—if the maze stays open.”',
          'Derya took the marked release bar. “I can hold every foam gate open.”',
          "She clipped the dropped flags beside fixed footprint-and-paw pads straddling the recessed groove.",
          "Hakan lined up everyone—tall, small, and paws.",
          "Lokum balanced on Hakan's shoe.",
          '“Beside me, not on me.”',
          "The horn inhaled.",
          "The final pennant became a thin purple spark.",
        ],
        image: "assets/cats-fortress-game-page-10.webp",
        alt: "Yusuf tracing the recessed groove as Derya holds the gate release and Hakan lines everyone up on fixed pads",
      },
      {
        title: "Nobody Left Behind!",
        paragraphs: [
          "Yusuf held one guarded handle. Hakan held the other.",
          "Derya used the release bar. Every foam gate stayed still.",
          "Lokum and Mercimek pressed the paw plates.",
          '“Tall, small, paws—PAUSE!”',
          "The brothers turned together.",
          "The finish strip slid through its recessed groove from behind the marked row to in front, touching nobody.",
          '“WHO WINS?” boomed the horn.',
          '“Nobody wins alone!” Hakan cried. “Everybody finishes!”',
          "CLICK! The Spinner stopped. The final purple spark vanished. The maze stayed still.",
        ],
        image: "assets/cats-fortress-game-page-11.webp",
        alt: "Hakan and Yusuf turning guarded handles as Derya holds the gates, the kittens press paw plates, and the finish crosses everyone",
      },
      {
        title: "The Game Finally Ends",
        paragraphs: [
          "At sunset, families played the new nobody-left-behind version. The horn celebrated finishers without shouting one name.",
          "Derya locked the Rule Spinner in its clear padded case.",
          '“No champion?” the horn asked softly.',
          '“Five finishers,” Hakan said.',
          '“Six shoes and eight paws,” Yusuf counted.',
          "Lokum sneezed the soft winner flags over the case.",
          "Inside, the red arrow pointed at its own reflection.",
          '“Spinner wins?” the horn guessed.',
          "Mercimek squeaked.",
          "Everyone laughed.",
          "The case stayed locked. The game was done.",
        ],
        image: "assets/cats-fortress-game-page-12.webp",
        alt: "The family laughing as Lokum sneezes soft flags over the locked Spinner case and its arrow points at its reflection",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Bosphorus Shadow Race",
    libraryKicker: "Harbor Cats of the Bosphorus — Book 1",
    readerKicker: "Four ferry whistles and one racing shadow",
    readerLayout: "compact-text",
    description:
      "A moon-shadow races along ferry signs, but Hakan and Yusuf discover it is warning them before the last whistle.",
    cover: "assets/book-cover-cats-bosphorus-shadow-race.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Bosphorus Shadow Race showing the children, kittens, and shadow-cat restoring glowing ferry signs",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "The Shadow Runs",
        paragraphs: [
          "The moon came up over the Bosphorus ferry pier.",
          "Hakan held Lokum inside his hoodie. Yusuf carried Mercimek in the soft blue kitten sling.",
          "Angela waved from the family bench. Koray stood by the dock worker at the locked rope gate.",
          "Then every old ferry sign clicked at once.",
          "TIK-TIK-TIK!",
          "A black cat-shaped shadow sprang from the seawall.",
          "It raced past Hakan's shoes.",
          "\"Catch it!\" cried Hakan.",
          "The shadow slapped one sign with its tail.",
          "The arrow spun toward the water.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-01.webp",
        alt: "A black cat-shaped moon shadow racing past Hakan, Yusuf, Deniz, and the kittens on a safe Bosphorus ferry pier",
      },
      {
        title: "Four Whistles",
        paragraphs: [
          "Deniz jumped from the ticket booth steps.",
          "\"That sign is not supposed to move,\" she said. Her red hat bounced as she ran.",
          "FOOOOT!",
          "The first ferry whistle rolled across the pier.",
          "Deniz held up four fingers. \"Boarding whistle. Then rope whistle. Then final call. Then departure.\"",
          "Yusuf studied the signs. \"So we have four whistles before the old route board sends the ferry to the wrong pier.\"",
          "The shadow-cat flicked its tail again.",
          "A second sign spun backward.",
          "Lokum sneezed.",
          "\"Pff-CHOO!\"",
          "The shadow bolted along the safe yellow line.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-02.webp",
        alt: "Deniz holding up four fingers as the first ferry whistle sounds and an old sign begins to spin",
      },
      {
        title: "Hakan Gives Chase",
        paragraphs: [
          "Hakan ran beside the yellow line, never past it.",
          "The shadow zipped under benches, over painted paw marks, and around a coil of thick ferry rope.",
          "\"It is making trouble!\" Hakan said.",
          "Mercimek squeaked from Yusuf's sling.",
          "Yusuf slowed down.",
          "\"Wait. It only touches signs after they rattle.\"",
          "Deniz pointed to the dock board. \"Those are harbor-cat signs. My grandpa says they guide night cats away from ferry wheels.\"",
          "The shadow stopped on a sign shaped like a little fish.",
          "The fish sign cracked.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-03.webp",
        alt: "Hakan running beside the yellow safety line while Yusuf notices the shadow-cat only touches rattling harbor-cat signs",
      },
      {
        title: "Rope Whistle",
        paragraphs: [
          "FOOOOT-FOOOT!",
          "\"Rope whistle,\" Deniz said.",
          "Two dock workers checked the ferry ropes. Koray lifted one hand to show the children where to stay.",
          "The cracked fish sign spun toward the locked rope rack.",
          "Hakan saw only shadow.",
          "Lokum saw one white paw.",
          "\"Meep,\" came a tiny sound.",
          "Hakan dropped to his knees behind the safety rail.",
          "Inside the rope rack, a small white kitten trembled between two thick coils. One loose loop lay over her tail.",
          "The shadow-cat sat beside the rack.",
          "It was not smiling.",
          "It was waiting.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-04.webp",
        alt: "Hakan spotting a white kitten tangled safely behind a locked rope rack while the shadow-cat waits nearby",
      },
      {
        title: "Not a Bad Shadow",
        paragraphs: [
          "\"It brought us here,\" Yusuf said.",
          "Hakan's cheeks went hot.",
          "\"I yelled catch it.\"",
          "The white kitten pressed herself smaller.",
          "Deniz unlocked the outer latch with the dock worker watching, but she did not reach in.",
          "\"If we pull the rope, she may panic.\"",
          "Mercimek squeaked softly.",
          "The white kitten lifted one ear.",
          "Hakan whispered, \"I know. Tiny can still be brave.\"",
          "He set Lokum beside him, away from the rack.",
          "Lokum did not pounce.",
          "For once, he only blinked.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-05.webp",
        alt: "Hakan, Yusuf, Deniz, Lokum, and Mercimek gently calming the frightened white kitten behind the rope rack",
      },
      {
        title: "The Basket Bridge",
        paragraphs: [
          "Yusuf opened Deniz's dock map on the bench.",
          "\"There is a service gap behind the rack,\" he said. \"A basket can slide through without touching the ropes.\"",
          "Koray and the dock worker brought a shallow padded basket with a long handle.",
          "They stayed outside the rail.",
          "Deniz guided the handle along the safe groove.",
          "Hakan hummed the tune Angela used at bedtime.",
          "Mercimek answered with one squeak.",
          "The white kitten sniffed.",
          "One paw stepped into the basket.",
          "Then another.",
          "The loose rope slipped off her tail.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-06.webp",
        alt: "Deniz guiding a padded basket through the safe service gap while Hakan hums and the white kitten steps in",
      },
      {
        title: "Final Call",
        paragraphs: [
          "FOOOOT! FOOOOT! FOOOOT!",
          "\"Final call!\" shouted Deniz.",
          "The dock worker drew the basket back. The white kitten curled under Hakan's small hand.",
          "\"Her name should be Pamuk,\" Hakan whispered.",
          "But the harbor-cat signs began to spin.",
          "Fish. Anchor. Moon. Paw.",
          "Backward.",
          "Backward.",
          "Backward.",
          "The ferry captain leaned from the window. \"Deniz, why is the old route board pointing to the closed pier?\"",
          "The shadow-cat stretched tall across the seawall.",
          "Its tail pointed to three signs at once.",
          "Yusuf swallowed.",
          "\"Saving Pamuk was only the first problem.\"",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-07.webp",
        alt: "The rescued kitten curled under Hakan's hand as ferry signs spin backward toward the wrong pier",
      },
      {
        title: "Wrong Pier",
        paragraphs: [
          "Deniz ran to the route board and stopped at the painted line.",
          "\"If the moon sign turns first, the ferry reads night route. If the anchor turns first, it reads docking route.\"",
          "\"What turns first now?\" asked Hakan.",
          "Every sign spun faster.",
          "Click-click-click-click!",
          "\"Nothing,\" Yusuf said. \"It is all noise.\"",
          "Lokum sneezed at the fish sign.",
          "The fish sign stopped.",
          "Mercimek squeaked at the paw sign.",
          "The paw sign stopped too.",
          "The shadow-cat looked at Hakan, then at Yusuf.",
          "It wanted helpers.",
          "Not chasers.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-08.webp",
        alt: "Yusuf and Deniz studying the noisy spinning signs as Lokum and Mercimek stop the fish and paw signs",
      },
      {
        title: "Three Safe Posts",
        paragraphs: [
          "Yusuf drew with his finger on Deniz's map.",
          "\"Fish for cats. Anchor for dock. Moon for night.\"",
          "Deniz nodded. \"Paw last, so the harbor cats know the route is safe.\"",
          "\"We need four signs,\" Hakan said, \"but we have three kids.\"",
          "Pamuk wriggled from the towel and bumped Hakan's wrist.",
          "Lokum stood by the fish sign.",
          "Mercimek stood by the paw sign.",
          "\"Five helpers,\" Hakan said.",
          "Koray and the dock worker held the service gate open only wide enough for the sign handles.",
          "No one stepped past the yellow safety line.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-09.webp",
        alt: "Hakan realizing there are five helpers as Lokum, Mercimek, and Pamuk stand by harbor-cat signs",
      },
      {
        title: "Departure Whistle",
        paragraphs: [
          "The ferry lights brightened.",
          "FOOOOOOT!",
          "Departure whistle.",
          "Deniz called, \"Fish!\"",
          "Lokum patted the fish plate.",
          "Click.",
          "\"Anchor!\"",
          "Yusuf turned the anchor handle.",
          "Click.",
          "\"Moon!\"",
          "Deniz turned the moon handle.",
          "Click.",
          "\"Paw!\"",
          "Mercimek froze.",
          "The big ferry horn had scared her flat.",
          "The shadow-cat slid beside her like a soft blanket.",
          "Hakan did not grab.",
          "He waited.",
          "\"You can choose the brave step,\" he whispered.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-10.webp",
        alt: "Deniz, Yusuf, and the kittens resetting the fish, anchor, moon, and paw signs during the departure whistle",
      },
      {
        title: "The Shadow Bridge",
        paragraphs: [
          "Mercimek touched the paw plate.",
          "CLICK!",
          "All four signs faced the same way.",
          "But the cracked fish sign wobbled.",
          "The shadow-cat leaped from the seawall. Its body stretched into a moon-dark bridge between the signs.",
          "Yusuf pointed. \"It is holding the route!\"",
          "Pamuk pressed her white paw on Hakan's sleeve.",
          "Hakan placed his hand gently beside the cracked sign, not on it.",
          "\"This way home,\" he said.",
          "The ferry captain blew one soft answer whistle and followed the corrected board.",
          "The ferry glided toward the bright open pier.",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-11.webp",
        alt: "The shadow-cat stretching into a moon-dark bridge to hold the cracked route sign steady for the ferry",
      },
      {
        title: "Harbor Cat Promise",
        paragraphs: [
          "The ferry docked safely.",
          "The harbor-cat signs glowed: fish, anchor, moon, paw.",
          "The shadow-cat shrank until it was only a small dark paw print on the seawall.",
          "The dock worker tightened the cracked fish sign. Deniz tied a blue ribbon beside it.",
          "\"For the Harbor Cats,\" she said.",
          "Pamuk curled between Lokum and Mercimek.",
          "Lokum sneezed the ribbon straight over Yusuf's shoe.",
          "Hakan laughed.",
          "Then the paw print moved.",
          "It pointed under the Bosphorus bridge, where seven lanterns flickered upside down.",
          "Yusuf folded the map.",
          "\"I think the Harbor Cats need us again.\"",
        ],
        image: "assets/cats-bosphorus-shadow-race-page-12.webp",
        alt: "Deniz tying a blue ribbon near the repaired fish sign as the paw print points toward seven lanterns under the bridge",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Lanterns Under the Bridge",
    libraryKicker: "Harbor Cats of the Bosphorus — Book 2",
    readerKicker: "Seven lanterns, two paths, and one upside-down clue",
    readerLayout: "compact-text",
    description:
      "Seven bridge lanterns confuse the harbor cats until the children teach them to follow real light first.",
    cover: "assets/book-cover-cats-lanterns-under-bridge.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Lanterns Under the Bridge showing the children and kittens guiding harbor cats with seven warm lanterns",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "Seven Lanterns Flicker",
        paragraphs: [
          "The shadow paw print led Hakan, Yusuf, Deniz, Lokum, Mercimek, and Pamuk along the supervised waterfront path.",
          "Angela and Koray walked close behind with warm coats and a kitten towel.",
          "Above them, the Bosphorus bridge hummed softly.",
          "Under it hung seven festival lanterns.",
          "One by one, their reflections wiggled in the dark water.",
          "Then the black shadow-cat ran across the wet stones.",
          "Its tail tapped the first lantern pole.",
          "The real lantern glowed.",
          "The reflection glowed brighter.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-01.webp",
        alt: "Seven bridge lanterns glowing and reflecting under the Bosphorus bridge as the shadow-cat taps the first pole",
      },
      {
        title: "The Upside-Down Path",
        paragraphs: [
          "\"That reflection is wrong,\" Yusuf said.",
          "Deniz counted the lanterns. \"Seven lights guide the harbor cats under the bridge.\"",
          "Lokum leaned toward the water.",
          "\"Not too close,\" Hakan whispered, scooping him back.",
          "On the path, white paw marks pointed ahead.",
          "In the water, silver paw marks pointed the other way.",
          "Mercimek squeaked.",
          "Pamuk hid behind Hakan's ankle.",
          "From under the bridge came many tiny meows.",
          "The harbor cats could not tell which path was real.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-02.webp",
        alt: "Hakan scooping Lokum away from the water while real paw marks and silver reflected paw marks point opposite ways",
      },
      {
        title: "Lantern One Goes Dark",
        paragraphs: [
          "The first lantern blinked out.",
          "POP.",
          "Only six real lights stayed warm.",
          "But all seven reflections still shimmered.",
          "\"If the real lanterns go dark,\" Deniz said, \"the midnight ferry convoy will follow water-glimmer instead of dock-light.\"",
          "Yusuf opened the dock map.",
          "\"We need to make the real path louder than the reflection.\"",
          "Hakan crouched by Pamuk.",
          "\"Tiny paws need brave lights,\" he told her.",
          "The shadow-cat slipped behind the second lantern.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-03.webp",
        alt: "The first bridge lantern going dark while Yusuf opens the map and harbor cats wait under the bridge",
      },
      {
        title: "Lokum's Bright Sneeze",
        paragraphs: [
          "Deniz handed Hakan a safe paper festival shade.",
          "\"Hold it high, not over the water.\"",
          "Hakan lifted it beside lantern two.",
          "Lokum sniffed the gold tassel.",
          "\"Lokum,\" Yusuf warned.",
          "\"Pff-CHOO!\"",
          "The tassel fluttered.",
          "The reflection shattered into sparkles.",
          "For one breath, the harbor cats saw the real path.",
          "Then lantern two went dark.",
          "POP.",
          "Five lights left.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-04.webp",
        alt: "Lokum sneezing at a safe paper lantern shade and briefly scattering the bright water reflection",
      },
      {
        title: "Yusuf's Mirror Rule",
        paragraphs: [
          "Yusuf watched the water.",
          "\"The reflections copy everything late,\" he said. \"Real light first. Water light second.\"",
          "Deniz clapped once.",
          "The lantern above them trembled.",
          "The reflection clapped back in ripples.",
          "Mercimek heard it first.",
          "\"Squeak!\"",
          "\"A call-and-answer,\" Yusuf said. \"If we make a pattern, cats can follow the first sound and first light.\"",
          "Under the bridge, green and amber cat eyes waited.",
          "Then lantern three went dark.",
          "POP.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-05.webp",
        alt: "Yusuf discovering the reflection copies late while Deniz claps and Mercimek hears the echo first",
      },
      {
        title: "The Missing Light",
        paragraphs: [
          "Four lanterns glowed above.",
          "Seven lanterns glowed below.",
          "\"One reflection is too bright,\" Hakan said.",
          "Deniz frowned at the row.",
          "\"The fifth lantern looks crooked.\"",
          "They walked to it, staying inside the rope line.",
          "The shadow-cat sat on the pole with both ears flat.",
          "The lantern was hanging upside down.",
          "Its warm light poured toward the water, not the path.",
          "\"So the light was not stolen,\" Yusuf said.",
          "\"It fell into its own reflection.\"",
        ],
        image: "assets/cats-lanterns-under-bridge-page-06.webp",
        alt: "The children finding the fifth lantern hanging upside down and pouring warm light into its reflection",
      },
      {
        title: "The Safe Reach",
        paragraphs: [
          "Koray called a festival helper with a long wooden hook.",
          "Angela wrapped Pamuk in the towel so she could watch without shaking.",
          "No child leaned over the rail.",
          "Deniz pointed from the map. \"Turn the lantern only when the wind pauses.\"",
          "The helper lifted the crooked lantern.",
          "Hakan hummed the bedtime tune.",
          "Mercimek squeaked the pause.",
          "The lantern swung upright.",
          "For a moment, all four real lights brightened.",
          "Then lantern four went dark.",
          "POP.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-07.webp",
        alt: "A festival helper using a long hook to turn the lantern upright while the children and kittens wait safely behind the rail",
      },
      {
        title: "False Brightness",
        paragraphs: [
          "\"We fixed it!\" Hakan cried.",
          "The harbor cats hurried forward.",
          "But the water reflections rushed ahead too.",
          "Silver paw marks climbed the bridge shadow and split into two paths.",
          "Half the cats turned toward the real lanterns.",
          "Half turned toward the water-glimmer.",
          "\"Stop!\" Deniz called softly, the way dock workers did near ropes.",
          "Yusuf shook his head.",
          "\"The fixed lantern helped, but the reflections still copy us.\"",
          "Only three real lanterns glowed.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-08.webp",
        alt: "Harbor cats splitting between real lanterns and water-glimmer after the fixed lantern creates a false victory",
      },
      {
        title: "Hakan's Soft Call",
        paragraphs: [
          "Hakan did not chase the cats.",
          "He knelt on the dry stones and tapped twice.",
          "Tap. Tap.",
          "Pamuk stepped beside him and tapped once with her white paw.",
          "Tap.",
          "Lokum sneezed a tiny sparkle from his whiskers.",
          "Mercimek answered with the softest squeak.",
          "Under the bridge, the nearest harbor cat stopped.",
          "\"They listen to small sounds,\" Hakan whispered.",
          "Yusuf's eyes lit.",
          "\"Then our pattern cannot be big. It has to be clear.\"",
        ],
        image: "assets/cats-lanterns-under-bridge-page-09.webp",
        alt: "Hakan and Pamuk tapping a soft pattern on dry stones as the nearest harbor cat stops to listen",
      },
      {
        title: "Real Light First",
        paragraphs: [
          "Two lanterns glowed.",
          "Deniz stood at lantern six.",
          "Yusuf stood at lantern seven with the map.",
          "Hakan, Lokum, Mercimek, and Pamuk waited at the first dry paw mark.",
          "\"Real light first,\" Yusuf said. \"Then water light. Follow first.\"",
          "Deniz lifted her safe shade.",
          "Hakan tapped twice.",
          "Pamuk tapped once.",
          "Mercimek squeaked.",
          "The lanterns blinked warm-gold in the same pattern.",
          "The water copied late in silver.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-10.webp",
        alt: "Deniz and Yusuf coordinating real warm-gold lantern blinks before the silver water reflections copy them",
      },
      {
        title: "The Lantern Song",
        paragraphs: [
          "The last real lantern began to dim.",
          "Deniz called, \"Warm!\"",
          "Hakan tapped. Tap, tap.",
          "Pamuk tapped. Tap.",
          "Mercimek squeaked.",
          "Lokum sneezed.",
          "\"Pff-CHOO!\"",
          "Yusuf pointed along the map. \"First glow! First sound! First paws!\"",
          "Every harbor cat chose the warm-gold path.",
          "The shadow-cat stretched under the bridge like a dark ribbon.",
          "Its paws touched each real lantern.",
          "One, two, three, four, five, six, seven.",
          "All seven lights woke.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-11.webp",
        alt: "All seven real lanterns waking as the shadow-cat stretches like a ribbon and harbor cats follow the warm path",
      },
      {
        title: "Under the Bridge",
        paragraphs: [
          "The midnight ferry convoy passed safely beyond the bridge lights.",
          "The harbor cats padded in a quiet line along the dry stones.",
          "Deniz tied seven tiny blue ribbons to the lantern rail.",
          "Pamuk touched noses with the oldest harbor cat.",
          "Lokum tried to look official.",
          "Then he sneezed a ribbon onto Yusuf's map.",
          "Everyone laughed.",
          "The shadow-cat shrank into one dark paw print beneath the bridge.",
          "It turned toward an old ferry clock.",
          "Behind the clock, something clicked open.",
        ],
        image: "assets/cats-lanterns-under-bridge-page-12.webp",
        alt: "Deniz tying seven blue ribbons to the lantern rail as the shadow paw print points toward an old ferry clock",
      },
    ],
  },
  {
    title: "Hakan, Yusuf, and the Secret Harbor Cats",
    libraryKicker: "Harbor Cats of the Bosphorus — Book 3",
    readerKicker: "One old ferry clock, many brave paws, and the route no one can lead alone",
    readerLayout: "compact-text",
    description:
      "Inside the hidden harbor room, the children help the cats learn that no one keeps Istanbul's routes alone.",
    cover: "assets/book-cover-cats-secret-harbor-cats.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and the Secret Harbor Cats showing many cats pressing paws to a glowing route map at dawn",
    seriesId: "cats-of-istanbul",
    pages: [
      {
        title: "The Clock Opens",
        paragraphs: [
          "The dark paw print pointed to an old ferry clock near the quiet pier.",
          "One hand pointed to the moon. The other pointed to dawn.",
          "Tick.",
          "Tick.",
          "Click.",
          "A small door opened behind the clock.",
          "Warm fish-shaped lights glowed down a short stair.",
          "Angela and Koray checked the rail, the steps, and the dock worker's nod.",
          "\"Together,\" Angela said.",
          "Hakan held Pamuk gently.",
          "Yusuf carried the map.",
          "Deniz led the way.",
        ],
        image: "assets/cats-secret-harbor-cats-page-01.webp",
        alt: "The old ferry clock opening behind a dark paw print while Hakan, Yusuf, Deniz, and the kittens prepare to enter together",
      },
      {
        title: "The Hidden Harbor Room",
        paragraphs: [
          "Behind the clock was a round room no ferry passenger ever saw.",
          "Tiny route signs covered the walls: fish, anchor, moon, paw, bridge, bell.",
          "Dozens of harbor cats sat in circles.",
          "Some were old and silver-whiskered.",
          "Some were round and sleepy.",
          "Some were kittens trying to sit tall.",
          "At the center lay a blank wooden route map.",
          "The shadow-cat stepped onto it.",
          "The room became quiet.",
        ],
        image: "assets/cats-secret-harbor-cats-page-02.webp",
        alt: "A hidden round harbor room behind the clock filled with route signs and circles of harbor cats",
      },
      {
        title: "Keeper of Routes",
        paragraphs: [
          "The oldest harbor cat touched the blank map.",
          "Moonlight drew three shining pictures above it:",
          "A paw.",
          "A ferry.",
          "A safe path.",
          "Deniz whispered, \"Keeper of Routes.\"",
          "Yusuf leaned closer. \"They choose who guides the signs at night.\"",
          "\"If the map stays tangled,\" Deniz said, \"the harbor cats will lose their safe dawn path—and the first ferry signs will not wake.\"",
          "One proud striped cat marched onto the map.",
          "Every sign pointed to him.",
          "He smiled.",
          "Then—ZIP!—every route line chased his tail and tied itself into one giant knot.",
        ],
        image: "assets/cats-secret-harbor-cats-page-03.webp",
        alt: "The oldest harbor cat presenting the Keeper of Routes map as a proud striped cat steps forward",
      },
      {
        title: "One Cat Alone",
        paragraphs: [
          "The striped cat tried again.",
          "He led with a high tail.",
          "The fish sign zipped after him.",
          "The anchor sign clonked behind it.",
          "But the bridge spun backward—and all three signs bumped into a heap.",
          "Pamuk meeped.",
          "Hakan understood her worried sound.",
          "\"He is trying to be first at everything.\"",
          "The shadow-cat's tail brushed the map.",
          "The tangled route vanished.",
          "Outside, the ferry clock ticked louder.",
          "Sunrise was coming.",
        ],
        image: "assets/cats-secret-harbor-cats-page-04.webp",
        alt: "The proud striped cat trying to lead alone while route signs tangle and Hakan understands Pamuk's worry",
      },
      {
        title: "Deniz's Perfect Route",
        paragraphs: [
          "Deniz placed four smooth stones on the map.",
          "\"Pier. Rope. Lantern. Ferry.\"",
          "The cats watched closely.",
          "Yusuf smiled. \"That is a good route.\"",
          "Deniz moved the stones in order.",
          "For one bright moment, the signs agreed.",
          "Then one corner—marked with a tiny kitten paw—stayed blank.",
          "Mercimek squeaked from Yusuf's sling.",
          "Deniz's face fell.",
          "\"I forgot the quietest paws.\"",
          "Above them, the clock went TICK-TICK-TICK. A thin stripe of dawn appeared under the door.",
        ],
        image: "assets/cats-secret-harbor-cats-page-05.webp",
        alt: "Deniz arranging pier, rope, lantern, and ferry stones but realizing the quiet kitten corner is blank",
      },
      {
        title: "Yusuf's Big Map",
        paragraphs: [
          "Yusuf spread his paper map beside the wooden one.",
          "He drew every sign from the last two adventures.",
          "Fish to anchor.",
          "Anchor to moon.",
          "Moon to paw.",
          "Bridge to lantern.",
          "\"If everyone follows this,\" he said, \"the first ferry will be safe.\"",
          "The map glowed.",
          "Then it curled at the edges.",
          "No cat moved.",
          "Yusuf swallowed.",
          "\"A map can show the way. It cannot walk it for them.\"",
        ],
        image: "assets/cats-secret-harbor-cats-page-06.webp",
        alt: "Yusuf's big paper map glowing and curling because a map cannot walk the route for the cats",
      },
      {
        title: "Hakan Listens Small",
        paragraphs: [
          "The stripe of dawn grew wider.",
          "Hakan sat on the floor.",
          "He did not point at the map.",
          "He listened.",
          "The proud striped cat stamped, eager to lead.",
          "The old silver cat touched the moon sign.",
          "Pamuk edged closer, afraid of being left behind.",
          "Lokum's nose began to wiggle.",
          "Mercimek covered his tiny ears with his paws.",
          "Hakan nodded.",
          "\"Maybe the Keeper is not one cat.\"",
        ],
        image: "assets/cats-secret-harbor-cats-page-07.webp",
        alt: "Hakan sitting on the floor and listening to every cat and kitten before suggesting the Keeper is not one cat",
      },
      {
        title: "Many Paws",
        paragraphs: [
          "The shadow-cat lifted its dark head.",
          "All around the room, route signs blinked once.",
          "Deniz gasped. \"It was never testing the best leader.\"",
          "Yusuf finished the thought. \"It was testing whether we could share the route.\"",
          "Hakan held out his hand. Pamuk chose the blank kitten corner.",
          "Lokum padded to the fish sign.",
          "Mercimek padded to the quiet bell.",
          "The proud striped cat stood at the anchor.",
          "The old silver cat stood at the moon.",
          "The map warmed under every paw.",
        ],
        image: "assets/cats-secret-harbor-cats-page-08.webp",
        alt: "Many cats and kittens taking places at fish, anchor, moon, bell, and kitten route signs as the map warms",
      },
      {
        title: "The First Ferry Wakes",
        paragraphs: [
          "FOOOOT!",
          "The first dawn ferry whistle shook the hidden room.",
          "Every cat jumped.",
          "Lokum sneezed.",
          "\"Pff-CHOO!\"",
          "The fish sign spun too fast.",
          "The anchor sign rattled.",
          "The moon sign dimmed.",
          "Outside, engines began to rumble.",
          "Deniz ran to the clock window.",
          "\"The first ferry is ready to leave.\"",
          "Yusuf pointed to the blank center of the map.",
          "\"We need the route to wake all at once.\"",
        ],
        image: "assets/cats-secret-harbor-cats-page-09.webp",
        alt: "The dawn ferry whistle startling everyone as Lokum sneezes and the signs spin too fast",
      },
      {
        title: "The Route Song",
        paragraphs: [
          "Hakan remembered the lantern pattern.",
          "\"Small sounds first.\"",
          "Deniz tapped the pier stone twice.",
          "Pamuk tapped once.",
          "Mercimek squeaked.",
          "Lokum took a deep breath.",
          "\"Soft sneeze,\" Hakan warned.",
          "\"Pff.\"",
          "Hakan raised one finger. \"When Yusuf calls, answer with your sound!\"",
          "Yusuf called, \"Fish! Anchor! Moon! Paw! Bridge! Bell!\"",
          "Tap! Clink! Mrrp! Pff! Thump! Ting!",
          "Every cat answered from its own sign.",
        ],
        image: "assets/cats-secret-harbor-cats-page-10.webp",
        alt: "Deniz, Pamuk, Mercimek, Lokum, and Yusuf creating the small route song across the hidden map",
      },
      {
        title: "Keeper Together",
        paragraphs: [
          "Dawn spilled gold through the clock window.",
          "The shadow-cat stretched across the wooden map.",
          "It did not choose one leader.",
          "It touched every paw.",
          "The proud striped cat lowered his tail, scooted over, and made room for Pamuk.",
          "Hakan held one edge of the map.",
          "Yusuf held the other.",
          "Deniz placed the final route stone in the middle.",
          "Pamuk pressed her tiny white paw beside it.",
          "All the harbor cats pressed their paws too.",
          "CLICK!",
          "Every ferry sign outside woke together.",
          "The first ferry turned safely toward open water.",
        ],
        image: "assets/cats-secret-harbor-cats-page-11.webp",
        alt: "The shadow-cat touching every paw as the children and harbor cats wake all ferry signs together at dawn",
      },
      {
        title: "The Harbor Cats' Secret",
        paragraphs: [
          "When the sun rose, the hidden room folded back behind the old clock.",
          "The harbor cats slipped into morning shadows.",
          "No one on the pier knew why every sign looked freshly polished.",
          "Deniz tied one blue ribbon inside the clock door.",
          "Yusuf copied the shared route onto his paper map and folded it.",
          "Hakan looked for the shadow-cat.",
          "Only one dark paw print remained.",
          "Then it split into three tiny prints: Lokum, Mercimek, and Pamuk.",
          "Pamuk bumped Hakan's shoe.",
          "The secret was safe.",
          "The Harbor Cats had many keepers now.",
        ],
        image: "assets/cats-secret-harbor-cats-page-12.webp",
        alt: "The hidden room folding behind the clock as three tiny dark paw prints appear for Lokum, Mercimek, and Pamuk",
      },
    ],
  },
  {
  ...
  {
    title: "Hakan, Yusuf, and Leonardo's Roaring Cave",
    libraryKicker: "Renaissance Tuscany Adventure",
    readerKicker: "A rising-water cave rescue with three fading bands",
    readerLayout: "compact-text",
    description:
      "A buried entrance, a false dragon, and one blue rope before Leonardo's last candle band disappears.",
    cover: "assets/book-cover-leonardo-roaring-cave.webp",
    coverAlt:
      "Cover art for Hakan, Yusuf, and Leonardo's Roaring Cave showing Hakan crossing a fossil cave in a safe rope seat",
    seriesId: "leonardo-italy",
    pages: [
      {
        title: "The Stone That Roared",
        paragraphs: [
          "At breakfast, the closed Living Sketchbook bumped once.",
          "BUMP!",
          "It coughed gray dust—and a stone covered in tiny white shells—across the table.",
          "Then came a sound from deep inside its pages.",
          "ROOOOM!",
          "The cups danced. The windows rattled.",
          "A boy's voice cried, “Leonardo! Help! The water is rising!”",
          "The Copper Feather flashed. The book opened onto a black cave—and the kitchen floor tipped toward it.",
        ],
        image: "assets/leonardo-roaring-cave-page-01.webp",
        alt: "The Living Sketchbook spitting out cave dust and a shell-covered stone as a magical cave doorway opens at the family's breakfast table",
      },
      {
        title: "No Way Back",
        paragraphs: [
          "The family landed beside Leonardo inside a cave beneath Vinci. Dusty Piuma jumped from his basket.",
          "“Tino chased Bruna inside,” Leonardo said. “His grandfather and the shepherds are searching the hill above us.”",
          "A cave pack beside him held spare rope and a folded canvas seat.",
          "ROOOOM!",
          "Stones sealed the bright entrance. Everyone was safe—but their way home was buried.",
          "Leonardo lifted one candle marked with three blue bands.",
          "“We find Tino and the upper way out before the last band burns away.”",
        ],
        image: "assets/leonardo-roaring-cave-page-02.webp",
        alt: "A rockfall sealing the cave entrance as Leonardo raises a candle with three blue bands beside the family and dusty Piuma",
      },
      {
        title: "The Blue-Rope Rule",
        paragraphs: [
          "Koray tied everyone to one strong blue guide rope and pulled every knot twice.",
          "“Nobody leaves the rope,” he said.",
          "Angela clapped three times.",
          "CLAP-CLAP-CLAP!",
          "From the darkness came two faint claps.",
          "“Tino!” Hakan called.",
          "Yusuf drew every turn on a little slate. Hakan found fresh hoofprints beside the stream.",
          "They followed together.",
          "Behind them, the water climbed over the shell-covered stone—and carried it into the dark.",
        ],
        image: "assets/leonardo-roaring-cave-page-03.webp",
        alt: "Koray checking the family's blue guide rope while Angela claps, Yusuf maps the cave, and Hakan spots goat hoofprints",
      },
      {
        title: "The Water Steps",
        paragraphs: [
          "The tunnel split in two. One path sloped down into rushing water. The other climbed across six wet stepping stones.",
          "“Up,” Yusuf said, marking the turn.",
          "Koray looped the guide rope around a stone pillar. One by one, they crossed. Hakan pointed to muddy hoofprints on the far side.",
          "Far above them, a church bell gave one tiny DONG.",
          "The candle hissed.",
          "FLICKER. SPUTTER.",
          "Two blue bands remained.",
        ],
        image: "assets/leonardo-roaring-cave-page-04.webp",
        alt: "The rope-linked family crossing six wet cave stepping stones as Yusuf chooses the upward path and two blue candle bands remain",
      },
      {
        title: "Eyes in the Dark",
        paragraphs: [
          "Two golden eyes appeared ahead.",
          "Piuma puffed until she looked twice her size.",
          "The eyes charged.",
          "“Dragon!” Hakan shouted.",
          "A shaggy goat burst into the candlelight, knocked Leonardo's cap sideways, and licked his beard.",
          "“Bruna!” Leonardo sputtered.",
          "The goat grabbed one corner of Yusuf's map. Piuma grabbed the other. For one ridiculous moment, goat and cat played tug-of-war.",
          "Then Hakan spotted a strip of Tino's red scarf caught on Bruna's horn.",
        ],
        image: "assets/leonardo-roaring-cave-page-05.webp",
        alt: "Bruna the goat licking Leonardo while Piuma plays tug-of-war and Hakan spots Tino's red scarf",
      },
      {
        title: "The Roar's Secret",
        paragraphs: [
          "ROOOOM!",
          "The roar blew through a wall of shell-shaped stone. Piuma's ribbon streamed toward a crack.",
          "“Wind,” Hakan said. “The mountain is blowing through the shells.”",
          "Leonardo held the candle near the crack. The flame leaned. He checked the rock above it.",
          "At floor level, Koray rolled one loose shell-stone aside. He crawled through and tested the ground. Then the rope line followed.",
          "Two clear claps came from ahead.",
          "There was no dragon.",
          "But Tino was still trapped.",
        ],
        image: "assets/leonardo-roaring-cave-page-06.webp",
        alt: "Hakan discovering wind through a shell-shaped cave wall while Koray safely opens a floor-level passage",
      },
      {
        title: "The One-Way Slide",
        paragraphs: [
          "CRRRACK!",
          "The muddy floor folded beneath their boots.",
          "The blue rope snapped tight and kept everyone together. Koray braced his feet. Leonardo caught Bruna. Angela caught Piuma's basket.",
          "They slid—WHOOSH!—into a lower chamber and landed in soft mud.",
          "Nobody was hurt.",
          "Behind them, stones filled the passage. Water spilled over the new wall and curled around their boots.",
          "Bruna shook mud all over Piuma.",
          "FLICKER. SPUTTER.",
          "One blue band remained.",
        ],
        image: "assets/leonardo-roaring-cave-page-07.webp",
        alt: "The blue guide rope holding everyone together during a safe muddy slide into a lower cave chamber",
      },
      {
        title: "Tino Across the Crack",
        paragraphs: [
          "“Here!” called Tino.",
          "He stood safely on a ledge across a deep crack. Behind him, a dry tunnel sloped upward.",
          "“I think it is the way out,” Tino called. “But I could not cross back!”",
          "A thick stone rib arched overhead. From his pack, Leonardo hung the canvas seat on doubled rope over the rib. One line ran to Koray. Hakan could carry the other loop to Tino's round stone column.",
          "No one asked Hakan.",
          "“I am scared,” he said. “Test every knot twice.”",
        ],
        image: "assets/leonardo-roaring-cave-page-08.webp",
        alt: "Tino waiting across the cave crack as Leonardo rigs a tested canvas rope seat beneath a natural stone rib",
      },
      {
        title: "One Small Brave Crossing",
        paragraphs: [
          "Koray tested the seat and overhead rope with his full weight. Leonardo checked the second line. Both men wound their ropes around the near stone pillar.",
          "Yusuf studied the ledge.",
          "“Aim for the round column,” he said. “Not the cracked edge.”",
          "Angela clapped a slow beat.",
          "CLAP. CLAP. CLAP.",
          "Hakan sat low. On Angela's beat, the adults eased the seat through one short swing.",
          "He landed beside the round column—exactly where Yusuf had pointed.",
        ],
        image: "assets/leonardo-roaring-cave-page-09.webp",
        alt: "Hakan making one short safe swing in the canvas rope seat while Koray and Leonardo control the lines and Yusuf guides the landing",
      },
      {
        title: "The Way Changes",
        paragraphs: [
          "Hakan slipped the prepared loop around the round column. Now the seat had one line on each side.",
          "He helped Tino sit. “You will not cross alone.”",
          "The adults pulled Tino across. Hakan drew the empty seat back, climbed in, and the adults brought him safely back.",
          "“Now we take Tino's dry tunnel up,” Yusuf said.",
          "For one happy breath, they had an exit.",
          "RUSHHHH! Water burst from that tunnel and sealed it with a roar.",
          "The candle's final blue band began to soften.",
        ],
        image: "assets/leonardo-roaring-cave-page-10.webp",
        alt: "Tino reunited safely with the family as water suddenly seals the dry tunnel behind his ledge",
      },
      {
        title: "The Upper Way Out",
        paragraphs: [
          "Piuma's wet ribbon lifted toward a narrow opening.",
          "“Fresh air!” Hakan cried.",
          "Yusuf turned his slate. “It leads above the flooded tunnel—toward the uphill turn I marked. The upper way out!”",
          "Koray climbed first with the guide rope. Angela clapped. The shepherds answered.",
          "They helped Tino, Bruna, Piuma, Angela, and Yusuf out. Hakan climbed next, with Leonardo below and Koray above. Leonardo followed.",
          "FLICKER. SPUTTER.",
          "The final blue band disappeared. The flame went out—but everyone was safely beneath the open sky.",
        ],
        image: "assets/leonardo-roaring-cave-page-11.webp",
        alt: "The family climbing the blue guide rope toward shepherds and rainy daylight as the final candle band disappears",
      },
      {
        title: "Brave Is Together",
        paragraphs: [
          "Tino ran into his grandfather's arms. Bruna rang her bell and tried to eat Leonardo's cap. Piuma snatched it away.",
          "Leonardo sketched the shell-covered stone from memory.",
          "“I was frightened,” Hakan said.",
          "“So was I,” Yusuf answered. “You found the air.”",
          "“And you found the way.”",
          "In the Living Sketchbook, two blue paths met beneath a small sunrise. The Copper Feather carried the family home.",
          "Far behind them, the cave gave one gentle drip-drop.",
          "This time, it sounded like applause.",
        ],
        image: "assets/leonardo-roaring-cave-page-12.webp",
        alt: "Tino hugging his grandfather on a Tuscan hillside as Hakan, Yusuf, the family, Leonardo, Piuma, and Bruna celebrate",
      },
    ],
  },
  {
...
const collections = [
  {
    ...
    description:
      "Secret cat paths, Tiny Paws rescues, impossible Istanbul games, and the Harbor Cats of the Bosphorus from ferry signs to bridge lanterns.",
    cover: "assets/book-cover-cats-of-istanbul.webp",
    coverAlt:
  ...
  },
  {
    ...
    description:
      "A living sketchbook carries the family through Renaissance cities, Leonardo's imagined Istanbul bridge, and a roaring cave beneath Vinci.",
    cover: "assets/book-cover-leonardo-wings-florence.webp",
    coverAlt:
